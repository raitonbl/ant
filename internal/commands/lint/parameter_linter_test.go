...
func TestLintParameter_where_parameter_reference_is_unresolvable(t *testing.T) {
	//TODO FIX
	doLintParameterSectionLinter(t, "index-046.json", Document, &Violation{Path: "/parameters/2/schema/items/type", Message: message.PARAMETER_TYPE_NOT_ALLOWED, Type: Document})
}
